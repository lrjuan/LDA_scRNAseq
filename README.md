...
clusterHGT automatically predicts cell types by identifying representative genes for each cell clusters and performing hypergeometric test against pre-established cell type marker LISTs.
